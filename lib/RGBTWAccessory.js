...
class RGBTWAccessory extends BaseAccessory {
    ...
    _addEventHandlers(dps) {
        ...
        this.device.on('change', (changes, state) => {
            ...
            switch (state['2']) {
                case 'white':
                    if (changes.hasOwnProperty('3') && this.convertBrightnessFromHomeKitToTuya(characteristicBrightness.value) !== changes['3']) characteristicBrightness.updateValue(this.convertBrightnessFromTuyaToHomeKit(changes['3']));
                    if (changes.hasOwnProperty('4') && this.convertColorTemperatureFromHomeKitToTuya(characteristicColorTemperature.value) !== changes['4']) {
                        if (characteristicHue.value !== 0) characteristicHue.updateValue(0);
                        if (characteristicSaturation.value !== 0) characteristicSaturation.updateValue(0);
                ...
                default:
                    if (changes.hasOwnProperty('5')) {
                        ...
                        if (unsetColorTemperature && characteristicColorTemperature.value !== 0) characteristicColorTemperature.updateValue(0);
